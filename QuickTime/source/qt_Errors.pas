...
{ All Rights Reserved. 							             }
{ 								                   	 }
{ The original file is: Errors.h, released dd Mmm yyyy. 		       }
{ The original Pascal code is: qt_Errors.pas, released 14 May 2000. 	 }
...
interface
 ...
 //Errors.h//
 const paramErr     = -50;       (*error in user parameter list*)
...
(* Locale Object Mgr errors*)
     ...
     (* QuickTime VR Errors *)
      ...
      badComponentInstance  = long($80008001);
      badComponentSelector  = long($80008002);
...
*)
 ...
 procedure SysError(errorCode:short); cdecl;

implementation

 procedure SysError; cdecl; external 'qtmlClient.dll';
